...
# and solving the inverse kinematics. However like that other scheme,
# this strategy also runs into difficulty at a manipulator singularity
...
# aligned resulting in the loss of one degree of freedom. This is revealed
# by the rank of the Jacobian

    linalg.matrix_rank( jacobn(p560, qr) )
#
# and the singular values are
#
    U, S, V = linalg.svd( jacobn(p560, qr) );
    S.T
pause % press any key to continue
#
