...
apt package manager installs Octave 4.2.2 excutable as /usr/bin/octave and
when invoked as a shell command the -W (--no-windows-system) option must be
specified to prevent execution failure with a "octave exited with signal 6"
message.
