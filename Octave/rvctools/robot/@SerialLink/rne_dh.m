...
function [tau,wbase] = rne_dh(robot, a1, a2, a3, a4, a5, a6)
    ...
    for p=1:np,
		...
		for j=n:-1:1,
            ...
            if debug,
                fprintf('t: ', j); fprintf('%.3f ', t)
                fprintf('\n\n');
            end
	    end % loop over j = n to 1
